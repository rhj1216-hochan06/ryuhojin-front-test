  ...
  ko: {
    ...
    homeProblems: [
      {
        ...
        value: "읽기 쉬운 배치",
        helper:
          "차트, 테이블, 상태 요약이 함께 있어도 정보 우선순위가 흐려지지 않게 구성합니다.",
      },
      {
        ...
        value: "예측 가능한 상태",
        helper:
          "검색, 필터, 선택, 편집 모드가 동시에 움직여도 조작 흐름을 유지합니다.",
      },
      {
        ...
        value: "이동과 리사이즈",
        helper:
          "기간 데이터, 표시 범위, 항목 편집을 분리해 timeline 조작을 안정화합니다.",
      },
      {
        ...
        value: "가로 넘침 방지",
        helper:
          "차트와 그리드가 작은 화면에서도 읽히도록 스크롤과 fallback을 준비합니다.",
      },
    ],
    homeCapabilities: [
      {
    ...
    chartCards: {
      businessTrend: {
        title: "막대 + 선형 차트",
        description:
          "월별 지표와 전환율을 하나의 옵션 생성 함수에서 생성합니다.",
        ariaLabel: "월별 매출, 활성 사용자, 전환율 차트",
        fallbackDescription:
          "월별 지표를 막대와 라인으로 함께 비교하는 차트입니다.",
      },
      implementationTrend: {
        title: "차트 구현 추이",
        description:
        ...
        fallbackDescription:
          "이전 값과 현재 값을 비교하고 리뷰 점수를 라인으로 표시하는 복합 차트입니다.",
      },
      qualityScatter: {
        title: "품질 산점도",
        description:
      ...
      capabilityTreemap: {
        title: "역량 트리맵",
        description:
          "차트 아카이브의 구현 영역을 크기와 색상 강도로 재구성한 treemap 예제입니다.",
        ariaLabel: "포트폴리오 시각화 역량 treemap",
        fallbackDescription:
          "ECharts, 마크업 차트, 공통 UX 항목의 비중을 treemap으로 표시합니다.",
      },
      categoryShare: {
        title: "파이 차트",
        description:
          "범례와 라벨이 있는 pie chart로 차트 예제 분포를 요약합니다.",
        ariaLabel: "차트 카테고리 비율 pie chart",
        fallbackDescription:
          "차트 예제 카테고리별 비율을 도넛 차트로 표시합니다.",
      },
      sankey: {
    ...
    timeline: {
      ...
      editorDescription:
        "왼쪽 리스트에서 제목, 그룹, 기간, 상태, 표시 여부를 수정합니다.",
      visibleLabel: "표시",
      titleLabel: "제목",
      groupLabel: "그룹",
      statusLabel: "상태",
  ...
  en: {
    ...
    homeProblems: [
      {
        ...
        helper:
          "Charts, tables, and status summaries keep a clear information order.",
      },
      {
        id: "editable-grid-flow",
        ...
        helper:
          "Search, filters, selection, and edit mode stay understandable together.",
      },
      {
        id: "timeline-workbench",
        ...
        helper:
          "Date ranges, visible windows, and item edits are handled separately.",
      },
      {
        id: "responsive-safety",
        ...
        value: "No overflow",
        helper:
          "Charts and grids stay readable on small screens with scroll and fallback text.",
      },
    ],
    homeCapabilities: [
      {
    ...
    chartCards: {
      businessTrend: {
        title: "Bar + Line",
        description:
          "Monthly metrics and conversion rate are generated from one option builder.",
      ...
      categoryShare: {
        title: "Pie Chart",
        description:
          "A pie chart with legend and labels summarizes the chart example mix.",
        ariaLabel: "Chart category share pie chart",
        fallbackDescription:
          "A donut chart showing the share of chart example categories.",
      },
      sankey: {
    ...
    timeline: {
      ...
      editorTitle: "Timeline Items",
      editorDescription:
        "Edit title, group, dates, status, and visibility from the left list.",
